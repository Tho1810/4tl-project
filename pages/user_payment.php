...
?>
        ...
        <hr color="orange"> 
        <br><br>
        <h3>Hình thức thanh toán sẽ là <b>Trả tiền mặt khi nhận hàng</b></h3>
        <h3>Thời gian xử lý giao hàng, tối thiểu là ba (3) ngày và tối đa là năm (5) ngày làm việc.</h3><br>
        <h5>4TL Shop</h5>
