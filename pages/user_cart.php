      ...
      <table class="table table-condensed table-bordered">
          ...
          ?>
              ...
              <tr>
                  ...
                  <td>     
                    <a href="edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-warning btn-round" type="button">Thêm số lượng</button></a>
                     <a href="delete_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-danger btn-round" onclick="return confirm('Are you sure you want to delete?')" type="button">Xóa</button></a>
                  </td>
            ...
            ?>
                ...
                <button  type="submit" id="" onclick="return confirm('Bạn có chắc chắn muốn thanh toán?')" name="submit" class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
                <i class="now-ui-icons shopping_bag-16"></i> Thanh toán</button> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Hồ Chí Minh City">Hồ Chí Minh</option>
                      <option value="Hà Nội City">Hà Nội</option>
                      <option value="Nha Trang Capital">Nha Trang</option>
                      <option value="Cam Ranh City">Cam Ranh</option>
                      <option value="Đà Nẵng City">Đà Nẵng</option>
                      <option value="Hải Phòng City">Hải Phòng</option>
                      <option value="Hải Dương City">Hải Dương</option>
                      <option value="Bình Dương City">Bình Dương</option>
                      <option value="Đồng Nai City">Đồng Nai</option>
                      <option value="Bình Phước City">Bình Phước</option>
                      <option value="Vĩnh Long City">Vĩnh Long</option>
                      <option value="Cần Thơ City">Cần Thơ</option>
                      <option value="Đà Lạt City">Đà Lạt</option>
                      <option value="Quy Nhơn City">Quy Nhơn</option>
                      <option value="Vinh City">Vinh</option>
                      <option value="Biên Hòa City">Biên Hòa</option>
                      </select>  
                      </div>
